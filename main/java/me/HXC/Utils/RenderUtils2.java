...
public final class RenderUtils2 extends MinecraftInstance {
    ...
    public static void autoExhibition(double d, double d1, double toDouble, double d2, double d3) {
    ...
    public static void drawGradientSideways2(double left, double top, double right, double bottom,final float radius, int col1, int col2) {
        float f = (float)(col1 >> 24 & 255) / 255.0F;
        float f1 = (float)(col1 >> 16 & 255) / 255.0F;
        float f2 = (float)(col1 >> 8 & 255) / 255.0F;
        float f3 = (float)(col1 & 255) / 255.0F;
    ...
    @Nullable
    public static Color skyRainbow(int i, float fl, float fl1, double d) {
        return null;
    }
}