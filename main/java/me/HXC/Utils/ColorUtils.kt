package me.HXC.Utils;

import com.google.gson.JsonObject
import me.HXC.Utils.RenderUtils2.skyRainbow
...
object ColorUtils {
    ...
    fun decodeColorJsonFormat(json: JsonObject):Color{
        return reAlpha(if(json.has("rainbow")){
            when(json.get("rainbow").asString.toLowerCase()){
                ...
                "sky" -> skyRainbow(if(json.has("rainbow_index")){json.get("rainbow_index").asInt}else{1},0.9f,1f,5.0)!!
    ...
    fun rainbow(): Color {
        ...
        return Color(currentColor.red / 255F * 1F, currentColor.green / 80f * 1F, currentColor.blue / 125F * 1F, currentColor.alpha / 255F)
    }
    ...
    fun colorCode(substring: String, get: Int): Color {
