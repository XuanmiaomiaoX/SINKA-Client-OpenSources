...
import net.ccbluex.liquidbounce.features.module.modules.player.SpinBot
...
class HeadRotations : Module() {
    ...
    private fun shouldRotate(): Boolean {
        ...
        return getState(Scaffold::class.java) || getState(Tower::class.java) ||
                ...
                getState(SpinBot::class.java) || getState(BowAimbot::class.java) ||
                getState(Fucker::class.java) || getState(CivBreak::class.java) || getState(Nuker::class.java) ||
                getState(ChestAura::class.java) || getState(BlockFly::class.java)
    }
}
