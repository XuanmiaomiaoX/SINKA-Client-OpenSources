...
import net.ccbluex.liquidbounce.features.module.modules.ghost.AutoTool
...
object Fucker : Module() {
    ...
    fun onUpdate(event: UpdateEvent) {
        ...
        when {
            ...
            actionValue.get().equals("destroy", true) || surroundings -> {
                ...
                if(attacks.get()) mc.thePlayer.sendQueue.addToSendQueue(C02PacketUseEntity(LiquidBounce.combatManager.target, C02PacketUseEntity.Action.ATTACK))
     ...
     */
    fun find(targetID: Int) = searchBlocks(rangeValue.get().toInt() + 1)
            .filter {
