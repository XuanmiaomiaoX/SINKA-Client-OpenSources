...
@ModuleInfo(name = "EnchantEffect", description = "rainbow EnchantEffect" ,category = ModuleCategory.RENDER)
class EnchantEffect : Module() {
    ...
    private val modeValue = ListValue("Mode", arrayOf("Rainbow", "AnotherRainbow", "Custom"), "Rainbow")


    fun getColor():Color{
        return when(modeValue.get().toLowerCase()){
            "rainbow" -> ColorUtils.rainbow()
            "anotherrainbow" -> RenderUtils.skyRainbow(10,0.9F,1F)
