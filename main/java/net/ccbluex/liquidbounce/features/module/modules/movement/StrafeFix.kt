...
@ModuleInfo(name = "StrafeFix",description = "StrafeFix by FDP", category = ModuleCategory.MOVEMENT)
class StrafeFix : Module() {
    ...
    public fun applyForceStrafe(isSilent: Boolean, runStrafeFix: Boolean) {
        silentFix = isSilent
        doFix = runStrafeFix
        isOverwrited = true
    }
