...
@ModuleInfo(name = "NoFall", description = "No landing damage.",category = ModuleCategory.PLAYER)
public class NoFall extends Module {
    public final ListValue modeValue = new ListValue("Mode", new String[]{"SpoofGround" ,"NoGround", "AAC5" ,"Packet", "OldAAC", "LAAC", "AAC3.3.11", "AAC3.3.15", "AACv4", "AAC5.0.14", "Spartan", "CubeCraft", "Hypixel", "Phase", "Verus", "HypixelNew", "HypixelAnother"}, "SpoofGround");
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        switch(modeValue.get().toLowerCase()) {
            ...
            case "aac5": {
                ...
                mc.getNetHandler().addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(mc.thePlayer.posX, mc.thePlayer.posY - 0.00001, mc.thePlayer.posZ, true));
                mc.thePlayer.motionX = 0.0000001F;
                mc.thePlayer.motionZ = 0.00000001F;
                mc.thePlayer.speedInAir *= 0.000001F;
                break;
            }
            case "phase":{
