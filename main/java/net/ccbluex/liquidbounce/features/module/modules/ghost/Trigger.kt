...
@ModuleInfo(name = "Trigger", description = "Automatically attacks the entity you are looking at.", category = ModuleCategory.GHOST)
class Trigger : Module() {
    ...
    private val soundValue = BoolValue("ClickSound", true)
