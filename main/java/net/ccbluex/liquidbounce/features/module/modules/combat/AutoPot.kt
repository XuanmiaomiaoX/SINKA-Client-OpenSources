            ...
            PRE -> {
                ...
                if (mc.thePlayer.health <= healthValue.get() && potionInHotbar != -1) {
                    ...
                    if (mc.thePlayer.rotationPitch <= 80F) {
                        RotationUtils.setTargetRotation(Rotation(if(!yaw.get()){mc.thePlayer.rotationYaw}else{RandomUtils.nextFloat(80F, 90F)}, RandomUtils.nextFloat(80F, 90F)))
                    }
                    return
                }
