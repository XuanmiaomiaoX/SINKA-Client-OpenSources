...
@ModuleInfo(name = "AntiStaff",  description = "1",category = ModuleCategory.MISC)
class AntiStaff : Module() {
    ...
    private val messageValue = TextValue("Message", "%staff% was detected as a staff member!")
    private val customURLValue = TextValue("CustomURL", "https://raw.githubusercontent.com/fdpweb/fdpweb.github.io/main/test")

    private val leaveValue = BoolValue("Leave",true)
    private val leaveMessageValue = TextValue("LeaveCommand","/hub")
