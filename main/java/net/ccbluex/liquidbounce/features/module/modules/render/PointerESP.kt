        ...
        for (entity in mc.theWorld.loadedEntityList) {
            if (entity is EntityPlayer && entity != mc.thePlayer) {
                ...
                if (MathHelper.sqrt_double(var7 * var7 + var9 * var9) < size / 2 - 4) {
                    ...
                    if (solidValue.get()){
                        RenderUtils.drawTriAngle(0F, 0F, 2.2F, 3F, color)
                        RenderUtils.drawTriAngle(0F, 0F, 1.5F, 3F, color)
                        RenderUtils.drawTriAngle(0F, 0F, 1.0F, 3F, color)
                        RenderUtils.drawTriAngle(0F, 0F, 0.5F, 3F, color)
                    } else
                        RenderUtils.drawTriAngle(0F, 0F, 2.2F, 3F, color)
