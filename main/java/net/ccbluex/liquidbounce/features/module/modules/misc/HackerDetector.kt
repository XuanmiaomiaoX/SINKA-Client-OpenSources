...
@ModuleInfo(name = "HackerDetector",description = "QQ539182578", category = ModuleCategory.PLAYER)
...
//        }
    ...
    private fun HackerData.flag(type: String, vl: Int, msg: String) {
        ...
        if (this.vl> vlValue.get()) {
            ...
            if (notifyValue.get()) {
                LiquidBounce.hud.addNotification(Notification("Hacker!", "This will be a wonderful HVH!", NotifyType.HACK, 9000))
            }
            this.vl = -vlValue.get()
