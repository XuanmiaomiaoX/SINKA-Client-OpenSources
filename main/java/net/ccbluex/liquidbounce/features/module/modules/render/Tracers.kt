...
class Tracers : Module() {
    ...
    private val thicknessValue = FloatValue("Thickness", 5F, 1F, 5F)
        ...
        for (entity in mc.theWorld.loadedEntityList) {
            if (entity != null && entity != mc.thePlayer && EntityUtils.isSelected(entity, false)) {
                ...
                val color = if (EntityUtils.isFriend(entity))
                    Color(ClientColor.colorRedValue.get(), ClientColor.colorGreenValue.get(), ClientColor.colorBlueValue.get(), 150)
