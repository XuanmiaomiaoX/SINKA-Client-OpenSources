...
class ModuleManager : Listenable {
    ...
    fun registerModules() {
        ...
        registerModules(
            ...
            CombatSound::class.java,
            ClientColor::class.java,
            ClientSettings::class.java,
            HVHBot::class.java,
            HYTNoSlow::class.java,
            Disabler::class.java,
            FireBallHelper::class.java,
            HackerDetector::class.java,
            AutoLogin::class.java,
            HUDSettings::class.java,
            ...
            AntiBan::class.java,
            KillAura::class.java,
            NoFallPlus::class.java,
            KeepSprint::class.java,
            AutoGG::class.java,
            NoSuffocation::class.java,
            AutoRegen::class.java,
            Trigger::class.java,
            Velocity::class.java,
            NewGhostHand::class.java,
            Fly::class.java,
            FixBlockSound::class.java,
            NameTags::class.java,
            FuckerHelper::class.java,
            IQBoost::class.java,
            AntiFireBall::class.java,
            VulCanFly::class.java,
            ClickGUI::class.java,
            VulCanSpeed::class.java,
            AutoPlay::class.java,
            NoFire::class.java,
            Derp::class.java,
            HighJump::class.java,
