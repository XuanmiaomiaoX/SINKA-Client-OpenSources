...
class ScoreboardElement(x: Double = 5.0, y: Double = 0.0, scale: Float = 1F,
    ...
    override fun drawElement(): Border? {
        ...
        RenderUtils.drawRoundRect(l1 - 2.0f, -2.0f, 5.0f, (maxHeight + fontRenderer.FONT_HEIGHT).toFloat(),3f,Color(0,0,0,120).rgb)
    ...
    private fun textColor() = Color(ClientColor.colorRedValue.get(), ClientColor.colorGreenValue.get(), ClientColor.colorBlueValue.get())
