...
open class HUD : MinecraftInstance() {
    ...
    companion object {
        ...
        val elements = arrayOf(
                Graph::class.java,
                SinkaUser::class.java,
                Radar::class.java,
                Arraylist::class.java,
                Image::class.java,
                ClientLogo::class.java,
                HVHRate::class.java,
    ...
    fun render(designer: Boolean) {
        for (element in elements) {
            ...
            try {
                ...
                ClientUtils.getLogger().error("Something went wrong while drawing ${element.name} element in HUD.", ex)
            }
