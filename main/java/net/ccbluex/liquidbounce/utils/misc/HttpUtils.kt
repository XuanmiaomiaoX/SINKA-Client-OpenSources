...
object HttpUtils {
    ...
    private const val DEFAULT_AGENT_CHINA = "Mozilla/4.0(compatible; MSIE 6.0; Windows NT 5.0; MyIE2; .NET CLR 1.1.4322)"
    ...
    private fun makeChina(url: String, method: String,
                     agent: String = DEFAULT_AGENT_CHINA): HttpURLConnection {
        val httpConnection = URL(url).openConnection() as HttpURLConnection
