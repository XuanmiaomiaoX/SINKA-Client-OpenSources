...
public class RenderWings extends ModelBase {
    ...
    public RenderWings() {
        this.location = new ResourceLocation("liquidbounce/wingsmod/wings.png");
    ...
    public void renderWings(float partialTicks) {
        ...
        double rotate = this.interpolate(per ? mc.thePlayer.rotationYaw : ((LiquidBounce.moduleManager.getModule(KillAura.class).getState() || LiquidBounce.moduleManager.getModule(Scaffold.class).getState()) ? Yaw : mc.thePlayer.prevRenderYawOffset), per ? mc.thePlayer.rotationYaw : ((LiquidBounce.moduleManager.getModule(KillAura.class).getState() || LiquidBounce.moduleManager.getModule(Scaffold.class).getState()) ? Yaw : mc.thePlayer.renderYawOffset), partialTicks);
        GL11.glPushMatrix();
