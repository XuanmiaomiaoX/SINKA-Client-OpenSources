...
import io.prplz.memoryfix.ClassTransformer;
...
@IFMLLoadingPlugin.Name("TransformerLoader")
...
public class TransformerLoader implements IFMLLoadingPlugin {
    ...
    public String[] getASMTransformerClass() {
        return new String[] {ForgeNetworkTransformer.class.getName(), AbstractJavaLinkerTransformer.class.getName(), "lain.mods.inputfix.InputFixTransformer", ClassTransformer.class.getName()};
    }
