...
import net.ccbluex.liquidbounce.utils.misc.Memory
import net.minecraft.util.ResourceLocation

object LiquidBounce {

//SINKA=CoolSense Base

    // Client information
    const val CLIENT_NAME = "LiquidBounce"
    const val COOLSENSE = "SINKA"
    const val COLORED_NAME = "SINKA"
    const val SINKA_VERSION = "4.3"
    const val CLIENT_VERSION = 72
    const val CLIENT_WEBSITE= "By Sinka"
    ...
    lateinit var tipSoundManager: net.ccbluex.liquidbounce.sound.TipSoundManager
    ...
    fun startClient() {
        ...
        ClientUtils.getLogger().info("Starting $COOLSENSE b$CLIENT_VERSION, by $CLIENT_CREATOR")
        ...
        tipSoundManager = net.ccbluex.liquidbounce.sound.TipSoundManager()

        // Register listeners
        eventManager.registerListener(Memory())
